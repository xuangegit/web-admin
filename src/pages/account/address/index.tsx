...
const Address: React.FC = () => {
  ...
  const [editModalConfig, setEditModalConfig] = useState<{ visible: boolean; id?: string }>({
    visible: false,
  });
  return (
    <PageContainer ghost fixedHeader>
      <ProTable
        ...
        options={false}
        toolBarRender={() => [
          <Button key="add" type="primary" onClick={() => setEditModalConfig({ visible: true })}>
            新增
          </Button>,
        ]}
        request={rule}
              ...
              return (
                <Space>
                  ...
                  <Button
                    size="small"
                    type="text"
                    onClick={() => setEditModalConfig({ visible: true, id: '3424' })}
                  >
                    编辑
                  </Button>
