...
import { PageContainer,ProForm,CheckCard,ProCard ,ProFormTextArea,ProFormItem,ProFormCheckbox} from '@ant-design/pro-components';
import { Card, Col, Row, Space, Button,Form,Table,Flex } from 'antd';
    ...
    return (
        <PageContainer>
            <Form>
                ...
                <ProCard title="送货清单" extra={<Button type="link">返回购物车</Button>} bordered={false} style={{marginTop:12}}>
                <Table
                    rowKey="id"
                    columns={[
                        {
                ...
                <div style={{marginTop:18}}>
                    <ProFormTextArea label="订单备注" name="remark" placeholder="请输入订单备注"  width={600} />
                    <ProFormItem name="sendType" label="配送方式" extra={<>因疫情原因，国内部分区域物流受影响，快递时效可能无法保障，造成不便，敬请谅解</>}>
                    ...
                    <ProFormCheckbox label="附加功能">为购买卡片开启自动续费 <Button type="link">了解更多</Button></ProFormCheckbox>
                </div>
                <ProCard ghost>
                    ...
                    <div className={styles.sumary_wrapper}>
                        <Flex gap={4} vertical>
                            ...
                            <div className={styles.userInfo}>寄送至： 上海 松江区 车墩镇 上海市松江区善德苑23栋1304室 收货人：轩乾辉 183****3010</div>
                        </Flex>
                    </div>
                    <div style={{textAlign:'right',marginTop:12}}> <Button size="large" type="primary">提交订单</Button></div>
                </ProCard>
            </Form>
        </PageContainer>
    )
